...
import { Menu, Search, Home, Shuffle, BookOpen } from 'lucide-react';
    ...
    <header className='flex justify-between items-center bg-card px-2 h-14'>
      ...
      <div className='flex items-center gap-3'>
        <button
          ...
          className='p-2 rounded-xl text-tema-brown cursor-pointer'
        >
          <Menu size={22} />
        </button>
        <Link href='/'>
      ...
      {isOpen && (
        <div
          className='z-40 fixed inset-0 bg-black/30'
